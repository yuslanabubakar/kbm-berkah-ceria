      ...
      <div className="grid gap-8 md:grid-cols-3">
        <div className="space-y-3 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="text-sm text-slate-600">
            Sistem menghitung pembagian biaya secara adil untuk semua peserta
            berdasarkan leg dan kendaraan yang dipakai.
          </p>
        </div>
        ...
        <div className="space-y-3 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="text-sm text-slate-600">
            Atur siapa duduk di mobil mana, supir mana, dan biaya otomatis
            dibagi per penumpang atau per leg.
          </p>
        </div>
        ...
        <div className="space-y-3 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="text-sm text-slate-600">
            Format Rupiah otomatis, mendukung angka desimal, dan saldo langsung
            update setiap ada pengeluaran baru.
          </p>
        </div>
      </div>
